...
<body >
    ...
    <main class="main">
        ...
        <button class="addContract" onclick="window.location.href='/new_contract.html'">New Contract</button>
            ...
            <table class='contracts_table'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td data-label=''>
                            <button onclick="window.location.href='/edit_contract.html'">Edit</button>
                        </td>
                    </tr>
                    <tr>
